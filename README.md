### **IMPORTANT: The Kinvey Angular SDK repository has now moved to: https://github.com/Kinvey/js-sdk/tree/master/packages/angular-sdk. Please go to this repository to submit issues and pull requests.**
